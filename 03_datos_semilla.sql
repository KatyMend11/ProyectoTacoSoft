...
-- =============================================
-- EMPLEADOS (12+, al menos 3 por sucursal, 1 gerente por sucursal)
-- =============================================
-- Culiacan (Sucursal 1)
...
-- =============================================
-- PROMOCIONES (3: 1 vigente, 1 expirada, 1 futura)
-- =============================================
...
-- Promocion 1 (Martes de Tacos) - aplica a tacos (productos 1-5)
INSERT INTO PromocionProductos (PromocionId, ProductoId) VALUES
(1, 1), (1, 2), (1, 3), (1, 4), (1, 5);

-- Promocion 2 (Verano Mazatlan) - aplica a bebidas y postres (productos 10-17)
INSERT INTO PromocionProductos (PromocionId, ProductoId) VALUES
(2, 10), (2, 11), (2, 12), (2, 13), (2, 14),
(2, 15), (2, 16), (2, 17);

-- Promocion 3 (Promo Inauguracion) - aplica a todo
INSERT INTO PromocionProductos (PromocionId, ProductoId) VALUES
(3, 1), (3, 2), (3, 3), (3, 4), (3, 5),
(3, 6), (3, 7), (3, 8), (3, 9),
...
-- =============================================
-- PEDIDOS (30+) y DETALLE_PEDIDO (60+)
-- =============================================

-- Pedidos en Culiacan (Sucursal 1)
...
-- Pedidos en Mazatlan (Sucursal 2)
INSERT INTO Pedidos (SucursalId, EmpleadoId, ClienteId, FechaHora, TipoPedido, Estatus, Total) VALUES
...
-- Pedidos en Los Mochis (Sucursal 3)
INSERT INTO Pedidos (SucursalId, EmpleadoId, ClienteId, FechaHora, TipoPedido, Estatus, Total) VALUES
...
-- Detalle de pedidos - Culiacan
-- Pedido 1: Juan Manuel - 3 tacos + 1 horchata
